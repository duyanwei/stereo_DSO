                            ...
                            float thFactor)
{
    ...
    //	else
    {
        ...
        // we will allow sub-selecting pixels by up to a quotia of 0.25,
        // otherwise we will re-select.
        ...
        if (recursionsLeft > 0 && quotia > 1.25 && currentPotential > 1)
        {
            ...
            //		printf("PixelSelector: have %.2f%%, need %.2f%%. RESAMPLE
            // with pot %d -> %d.\n",
                        ...
                        for (int x2 = 0; x2 < mx2; x2 += pot)
                        {
                            ...
                            for (int y1 = 0; y1 < my1; y1 += 1)
                                for (int x1 = 0; x1 < mx1; x1 += 1)
                                {
                                    ...
                                    float ag1 =
                                        mapmax1[(int)(xf * 0.5f + 0.25f) +
                                                (int)(yf * 0.5f + 0.25f) * w1];
                                    if (ag1 > pixelTH1 * thFactor)
                                    {
                                        Vec2f ag0d = map0[idx].tail<2>();
                                        float dirNorm =
                                            fabsf((float)(ag0d.dot(dir3)));
                                        if (!setting_selectDirectionDistribution)
                                            dirNorm = ag1;
                                    ...
                                    float ag2 =
                                        mapmax2[(int)(xf * 0.25f + 0.125) +
                                                (int)(yf * 0.25f + 0.125) * w2];
                                    if (ag2 > pixelTH2 * thFactor)
                                    {
                                        Vec2f ag0d = map0[idx].tail<2>();
                                        float dirNorm =
                                            fabsf((float)(ag0d.dot(dir4)));
                                        if (!setting_selectDirectionDistribution)
                                            dirNorm = ag2;
