...
public:
            ...
            connectivity) override
    {
        ...
        for (const std::pair<uint64_t, Eigen::Vector2i>& p : connectivity)
        {
            ...
            printf("OUT: Example Edge %d -> %d has %d active and %d marg "
                   "residuals\n",
                                  ...
                                  bool final, CalibHessian* HCalib) override
    {
        ...
        {
            printf("OUT: KF %d (%s) (id %d, tme %f): %d active, %d "
                   "marginalized, %d immature points. CameraToWorld:\n",
            ...
            {
                printf("OUT: Example Point x=%.1f, y=%.1f, idepth=%f, idepth "
                       "std.dev. %f, %d inlier-residuals\n",
    ...
    {
        printf("OUT: Predicted depth for KF %d (id %d, time %f, internal "
               "frame-ID %d). CameraToWorld:\n",
